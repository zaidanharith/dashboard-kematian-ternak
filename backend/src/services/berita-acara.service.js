...
function buildBeritaAcaraData(laporan) {
  ...
  return {
    nomor_urut: laporan.nomorBeritaAcara || '-',
    ...
    alamat_peternak: `${laporan.ternak.peternak.alamat}, Dusun ${laporan.ternak.peternak.dusun} RT ${laporan.ternak.peternak.rt}/RW ${laporan.ternak.peternak.rw}`,
